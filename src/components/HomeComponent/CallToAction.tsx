...
const CTASection = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 lg:py-12 lg:px-8">
      <div
        ref={sectionRef}
      ...
      >
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-semibold bg-gradient-to-r from-white via-blue-200 to-purple-200 bg-clip-text text-transparent mb-8">
              {title.split("\n").map((line, index) => (
                <span key={index}>
                  {index === 1 ? (
